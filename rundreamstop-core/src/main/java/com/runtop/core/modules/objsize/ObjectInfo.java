package com.runtop.core.modules.objsize;
 ...
 * rundreams.net
 *
 * @Author:zzh rundreams@yeah.net  @Time:2018/7/1
 */
...
public class ObjectInfo {
    ...
    public Double getSizeStr() {
        long ln = getDeepSize();
        BigDecimal d = BigDecimal.valueOf(ln / 2000);
        BigDecimal dd = new BigDecimal(1024);
        return d.divide(dd, 2, BigDecimal.ROUND_HALF_UP).doubleValue();
    }
