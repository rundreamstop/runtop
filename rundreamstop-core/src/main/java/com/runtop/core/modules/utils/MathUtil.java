...
public final strictfp class MathUtil {
    ...
    /**
     * 将decimal 乘以数字 然后转化为int
     *
     * @param decimal
     * @param mu
     * @return
     */
    public static final Integer decimalToInt(BigDecimal decimal, Integer mu) {
        BigDecimal bd = decimal.multiply(new BigDecimal(mu));
        return bd.intValue();
    }

    public static final Integer decimalToInt(String decimal, Integer mu) {
        BigDecimal bd = new BigDecimal(decimal).multiply(new BigDecimal(mu));
        return bd.intValue();
    }

    public static final void main(String[] args) {
        System.out.println(decimalToInt(new BigDecimal("19.9444"),10));
    }
}
