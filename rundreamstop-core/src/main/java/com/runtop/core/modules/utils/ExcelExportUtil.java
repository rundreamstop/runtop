...
public class ExcelExportUtil {
    ...
    public static void write(String title, List<LinkedHashMap<String, Object>> dataList,
        ...
        WritableFont columnFont = new WritableFont(
        ...
        while (headerItor.hasNext()) {
            ...
            ++c;
            wlabel = new Label(c, 0, cell.toString(), columnFormat);
        ...
        for (LinkedHashMap<String, Object> dataMap : dataList) {
            ...
            while (it.hasNext()) {
                ...
                Object cell = dataMap.get(key);
                wlabel = new Label(col, row, cell == null ? "" : String.valueOf(cell),
                        normalFormat);
                wsheet.addCell(wlabel);
            }
            col = -1;
